...
LABELS_DIR = "/home/daniel/deepsy/SBS_Analize/Trans2Label/ProcessLabels/trans_rupture_03"  # change
...
def makeGraph(label_values):
    ...
    N, bins, patches = plt.hist(label_values, bins=np.arange(3) - 0.5, edgecolor='white', linewidth=5)

    plt.ylabel('Count')
    plt.xlabel('PSQ label')
    # plt.title(title)
    plt.grid()
    ...
    plt.savefig('psq_vanilla_HD.png', dpi=1200)
    # plt.show()
